...
| `ReceiptStatus`, `Receipt`, `OcrReceiptItem` | `other` | `src/app/core/models/receipt.model.ts` |
| `ShoppingListStatus`, `ShoppingList`, `ListItem`, `PopulatedListItem`, `ActiveShoppingList` | `other` | `src/app/core/models/shopping-list.model.ts` |
